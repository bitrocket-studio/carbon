...
class Editor extends React.Component {
  ...
  getCarbonImage = async (
    { format, squared = this.state.squaredImage, exportSize = (EXPORT_SIZES_HASH[this.state.exportSize] || DEFAULT_EXPORT_SIZE).value } = {
      format: 'png',
    },
  ) => {
  ...
  tweet = () => {
    this.getCarbonImage({ format: 'png' }).then(this.context.tweet.bind(null, this.state.code || DEFAULT_CODE));
  };
    ...
    return (
      <div className="editor">
        <Toolbar>
          ...
          <div className="toolbar-second-row">
            ...
            <div className="share-buttons">
              ...
              <ExportMenu onChange={this.updateSetting} exportImage={this.exportImage} exportSize={exportSize} />
            </div>
          </div>
        </Toolbar>
        ...
        <Dropzone accept="image/*, text/*, application/*" onDrop={this.onDrop}>
          {({ canDrop }) => (
            <Overlay isOver={canDrop} title={`Drop your file here to import ${canDrop ? '✋' : '✊'}`}>
